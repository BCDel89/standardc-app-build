...
const routes = [
    ...
    {
        path: 'user-settings',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_user-settings_user-settings_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./user-settings/user-settings.module */ 7552)).then(m => m.UserSettingsPageModule)
    },
];
...
let CacheService = class CacheService {
    ...
    get(key, defValue = null) {
        let value = window.localStorage.getItem(key) || defValue;
        try {
    ...
    set(key, value) {
        try {
            ...
            console.log('value could not be stringified!', e);
        }
...
CacheService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony import */ var _cache_service__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cache.service */ 3399);
...
let SessionService = class SessionService {
    ...
    load() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__awaiter)(this, void 0, void 0, function* () {
            this.token = this.cache.get(TOKEN_KEY);
    ...
    setToken(token) {
        ...
        this.token = token;
        this.cache.set(TOKEN_KEY, token);
    }
};
